...
Route::group(['middleware' => 'auth'], function () {
    Route::namespace('Authenticated')->group(function () {
        ...
        Route::namespace('BulletinBoard')->group(function () {
            ...
            // コメントカウント
            Route::get('/bulletin_board/posts', 'PostsController@commentCounts');
            Route::post('/bulletin_board/posts', 'PostsController@commentCounts');
            ...
            //   投稿画面へ
            Route::get('/bulletin_board/create', 'PostsController@postInput')->name('post.create');
